...
const AngorPosts = () => {
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-8">
      {posts.length === 0 && connectionStatus !== 'error' && (
        <div className="flex justify-center items-center py-20">
          <div className="relative w-20 h-20">
            <div className="absolute top-0 left-0 w-full h-full">
              <div className="w-20 h-20 border-8 border-cyan-200 rounded-full"></div>
              <div className="w-20 h-20 border-8 border-cyan-600 rounded-full border-t-transparent animate-spin absolute top-0 left-0"></div>
            </div>
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
              <svg className="w-8 h-8 text-cyan-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
